...
class WPBean_WC_Related_Products_Slider_DiscountPage
{
	...
	public $args = array(
		...
		'notice_exception'  	=> 'admin_page_wpbean-discount',
		'notice_dismiss_key' 	=> 'wpbean_wc_related_products_slider_pro_discount_dismiss',
		'notice_action' 		=> 'wpbean_wc_related_products_slider_discount_admin_notice_dismissed',
		'notice_meta_key' 		=> 'wpbean_wc_related_products_slider_pro_discount_dismissed',
	);
	...
	public function menu_page_content() {
		...
		$tag      = '576';
		$response = wp_remote_get( "https://wpbean.com/edd-api/v2/products/?key={$key}&token={$token}&tag={$tag}&number=20&orderby=menu_order&order=DESC" );
